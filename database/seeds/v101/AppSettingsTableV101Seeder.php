...
class AppSettingsTableV101Seeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('app_settings')->insert(array(
            ...
            array(
                'id' => 34,
                'key' => 'app_logo',
                'value' => '6977744d-4936-48d2-82b0-94d34cf9a571',
            ),
            array(
                'id' => 35,
                'key' => 'nav_color',
                'value' => 'navbar-dark navbar-purple',
            ),
            array(
                'id' => 38,
                'key' => 'logo_bg_color',
                'value' => 'text-light navbar-purple',
            ),
            array(
                'id' => 66,
                'key' => 'default_role',
            ...
            array(
                'id' => 124,
                'key' => 'google_maps_key',
                'value' => 'AIzaSyCEkXbIXK1D1tik6ny4lqiFdwo9RolKgJE',
            ),
            array(
                'id' => 125,
                'key' => 'mobile_language',
