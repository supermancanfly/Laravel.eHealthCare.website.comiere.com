        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="d-flex flex-column col-sm-12 col-md-6">
                    ...
                    <!-- doctor_app_name Field -->
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        {!! Form::label('doctor_app_name', trans("lang.app_setting_doctor_app_name"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('doctor_app_name', setting('doctor_app_name'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_doctor_app_name_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_doctor_app_name_help") }}
                            </div>
                        </div>
                    </div>
                    <!-- clinic_app_name Field -->
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        {!! Form::label('clinic_app_name', trans("lang.app_setting_clinic_app_name"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('clinic_app_name', setting('clinic_app_name'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_clinic_app_name_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_clinic_app_name_help") }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-8">
                            ...
                            'navbar-dark navbar-maroon' => trans('lang.app_setting_maroon'),
                            'navbar-dark navbar-purple' => trans('lang.app_setting_purple'),
                            'navbar-dark navbar-fuchsia' => trans('lang.app_setting_fuchsia'),
                            ...
                            'navbar-light navbar-olive' => trans('lang.app_setting_olive'),
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-8">
                            ...
                            'text-light  navbar-maroon' => trans('lang.app_setting_maroon'),
                            ...
                            'text-dark  navbar-olive' => trans('lang.app_setting_olive'),
