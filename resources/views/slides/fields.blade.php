...
<!-- Image Fit Field -->
    ...
    <!-- E Service Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('doctor_id', trans("lang.slide_doctor_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('doctor_id', $doctor, null, ['data-empty'=>trans("lang.slide_doctor_id_placeholder"), 'class' => 'select2 not-required form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.slide_doctor_id_help") }}</div>
        </div>
    </div>

    <!-- Clinic Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('clinic_id', trans("lang.slide_clinic_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('clinic_id', $clinic, null, ['data-empty'=>trans("lang.slide_clinic_id_placeholder"), 'class' => 'select2 not-required form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.slide_clinic_id_help") }}</div>
        </div>
    </div>
