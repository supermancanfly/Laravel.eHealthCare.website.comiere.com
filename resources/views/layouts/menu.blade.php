...
@can('doctors.index')
    <li class="nav-item has-treeview {{ Request::is('doctors*') || Request::is('doctorReviews*')|| Request::is('availabilityHours*')|| Request::is('experiences*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{  Request::is('doctors*') || Request::is('doctorReviews*')|| Request::is('availabilityHours*')|| Request::is('experiences*') ? 'active' : '' }}"> @if($icons)
        ...
        <ul class="nav nav-treeview">
            @can('doctors.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('doctors*') ? 'active' : '' }}" href="{!! route('doctors.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-user-md"></i>@endif
                        <p>{{trans('lang.doctor_table')}}</p></a>
                </li>
            @endcan
            @can('doctorReviews.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('doctorReviews*') ? 'active' : '' }}" href="{!! route('doctorReviews.index') !!}">@if($icons)
...
<li class="nav-item has-treeview {{ Request::is('appointments*') || Request::is('appointmentStatuses*') || Request::is('deliveryAddresses*')? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ Request::is('appointments*') || Request::is('appointmentStatuses*') || Request::is('deliveryAddresses*')? 'active' : '' }}"> @if($icons)
        ...
        <p>{{trans('lang.appointment_plural')}} <i class="right fas fa-angle-left"></i>
        </p>
    </a>
    <ul class="nav nav-treeview">
        ...
        @can('appointmentStatuses.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('appointmentStatuses*') ? 'active' : '' }}" href="{!! route('appointmentStatuses.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-server"></i>@endif<p>{{trans('lang.appointment_status_plural')}}</p></a>
            </li>
        @endcan
...
<!-- @if(Module::isActivated('Subscription'))
    ...
    @can('clinicSubscriptions.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('clinicSubscriptions*') ? 'active' : '' }}" href="{!! route('clinicSubscriptions.index') !!}">@if($icons)
                    <i class="nav-icon fa fa-address-card"></i>@endif<p>{{trans('subscription::lang.clinic_subscription_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
        </li>
    @endcan
@endif
...
@if(Module::isActivated('Pharmacies'))
    ...
    @can('pharmacies.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('pharmacies*') ? 'active' : '' }}" href="{!! route('pharmacies.index') !!}">@if($icons)
                    <i class="nav-icon fas fa-first-aid"></i>@endif<p>{{trans('pharmacies::lang.pharmacy_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
        </li>
    @endcan
    @can('medicines.index')
        <li class="nav-item has-treeview {{ Request::is('medicines*') || Request::is('forms*') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ Request::is('medicines*') || Request::is('forms*') ? 'active' : '' }}"> @if($icons)
                    <i class="nav-icon fas fa-capsules"></i>@endif
                <p>{{trans('pharmacies::lang.medicine_plural')}}<i class="right fas fa-angle-left"></i>
                </p>
            </a>
            <ul class="nav nav-treeview">
                @can('medicines.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('medicines*') ? 'active' : '' }}" href="{!! route('medicines.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-capsules"></i>@endif<p>{{trans('pharmacies::lang.medicine_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
                    </li>
                @endcan
                @can('forms.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('forms*') ? 'active' : '' }}" href="{!! route('forms.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-flask"></i>@endif<p>{{trans('pharmacies::lang.form_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
                    </li>
                @endcan
    ...
    @can('categories.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('categories*') ? 'active' : '' }}" href="{!! route('categories.index') !!}">@if($icons)
                    <i class="nav-icon fas fa-book-medical"></i>@endif<p>{{trans('pharmacies::lang.category_plural')}}@if (config('installer.demo_app')) <span class="right badge badge-danger">Addon</span> @endif</p></a>
        </li>
    @endcan
    @can('orders.index')
        <li class="nav-item has-treeview {{ Request::is('orders*') || Request::is('orderStatuses*') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ Request::is('orders*') || Request::is('orderStatuses*') ? 'active' : '' }}"> @if($icons)
                    <i class="nav-icon fas fa-shopping-bag"></i>@endif
                ...
                @can('orders.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('orders*') ? 'active' : '' }}" href="{!! route('orders.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-shopping-bag"></i>@endif<p>{{trans('pharmacies::lang.order_plural')}}</p></a>
                    </li>
                @endcan
                @can('orderStatuses.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('orderStatuses*') ? 'active' : '' }}" href="{!! route('orderStatuses.index') !!}">@if($icons)
                                <i class="nav-icon fa fa-server"></i>@endif<p>{{trans('pharmacies::lang.order_status_plural')}}</p></a>
                    </li>
                @endcan
    ...
    <li class="nav-item has-treeview {{ Request::is('payments*') || Request::is('paymentMethods*') || Request::is('paymentStatuses*')|| Request::is('clinicPayouts*') ? 'menu-open' : '' }}">
        ...
        <ul class="nav nav-treeview">
            ...
            @can('clinicPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('clinicPayouts*') ? 'active' : '' }}" href="{!! route('clinicPayouts.index') !!}">@if($icons)
