...
class AvailabilityHourControllerTest extends TestCase
{
    ...
    public function testStore()
    {
        ...
        $this->assertDatabaseHas(AvailabilityHour::getModel()->table, [
            ...
            'clinic_id' => $availabilityHour->clinic_id
        ]);
    ...
    public function testRequiredFieldsWhenStore()
    {
        ...
        $availabilityHour['clinic_id'] = null;
        ...
        $response->assertSessionHasErrors("clinic_id", __('validation.required', ['attribute' => 'clinic_id']));
    }
    ...
    {
        $user = TestHelper::getAdmin();
        $availabilityHour = factory(AvailabilityHour::class)->states(['day_more_16_char', 'not_exist_clinic_id', 'end_at_lest_start_at'])->make();
        $response = $this->actingAs($user)
            ->post(route('availabilityHours.store'), $availabilityHour->toArray());
        ...
        $response->assertSessionHasErrors("clinic_id", __('validation.exists', ['attribute' => 'clinic_id']));
    }
