...
class FaqCategoryControllerTest extends TestCase
{
    ...
    public function testIndex()
    {
        ...
        $response->assertSeeTextInOrder(["Faq Specialities Management", "Faq Specialities List", "Create Faq Speciality"]);
    }

    /**
     * Test Create Faq Specialities
     * @return void
     */
    public function testCreate()
    {
        ...
        $response->assertStatus(200);
        $response->assertSeeTextInOrder(["Faq Specialities Management", "Name"]);
    }
